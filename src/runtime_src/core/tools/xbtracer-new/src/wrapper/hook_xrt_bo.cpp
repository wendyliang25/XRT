...
copy(const xrt::bo& src, size_t sz, size_t src_offset, size_t dst_offset)
{
  ...
  typedef void (*func_t)(void*, const xrt::bo&, size_t, size_t, size_t);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
  ...
  ofunc((void*)this, src, sz, src_offset, dst_offset);
...
read(void* dst, size_t size, size_t skip)
{
  ...
  typedef void (*func_t)(void*, void*, size_t, size_t);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
...
sync(xclBOSyncDirection dir, size_t sz, size_t offset)
{
  ...
  typedef void (*func_t)(void*, xclBOSyncDirection, size_t, size_t);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
...
write(const void* src, size_t size, size_t seek)
{
  ...
  typedef void (*func_t)(void*, const void*, size_t, size_t);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
...
async(xclBOSyncDirection dir, size_t sz, size_t offset)
{
  ...
  typedef xrt::bo::async_handle (*func_t)(void*, xclBOSyncDirection, size_t, size_t);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
  ...
  xrt::bo::async_handle ret_o = ofunc((void*)this, dir, sz, offset);
...
export_buffer()
{
  ...
  typedef xrt::bo::export_handle (*func_t)(void*);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
  ...
  xrt::bo::export_handle ret_o = ofunc((void*)this);
...
get_flags() const
{
  ...
  typedef xrt::bo::flags (*func_t)(void*);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
  ...
  xrt::bo::flags ret_o = ofunc((void*)this);
...
~bo()
{
  const char* func_s = "xrt::bo::~bo(void)";
  typedef void (*func_t)(void*);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
...
get_memory_group() const
{
  ...
  typedef xrt::memory_group (*func_t)(void*);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  bool need_trace;
  ...
  xrt::memory_group ret_o = ofunc((void*)this);
